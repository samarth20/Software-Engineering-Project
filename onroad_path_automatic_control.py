# Some inspiration from https://github.com/carla-simulator/leaderboard/blob/master/scripts/route_creator.py
...
def game_loop(args):
    ...
    # Set the initial spawn point for the vehicle for TOWN 7

    # Initialize variables
    vehicles = []

    if world.player:
        vehicles.append(world.player)
        print(f'Spawned {len(vehicles)} vehicles. Press Ctrl+C to exit.')
        ...
        traffic_manager.distance_to_leading_vehicle(world.player, 0)
        traffic_manager.set_desired_speed(world.player, desired_speed)
    ...
    try:
        while True:
            ...
            if world.player and world.player.get_transform().location.distance(route_1[-1]) < 0.8:
...
def main():
    ...
    argparser.add_argument(
        ...
        help='Actor filter (default: "vehicle.audi.etron")')
    argparser.add_argument(
        '--generation',
        metavar='G',
        default='2',
